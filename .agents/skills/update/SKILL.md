...
Keep the command session alive so the user can test. Report the branch and commit that were started, the frontend URL, API health URL, and any command failure. Ctrl+C stops the frontend and API; the local database remains running.
