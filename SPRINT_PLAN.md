...
**Stav (2026-09-23):** PT-UX-1 a PT-UX-2 jsou implementovány v `apps/web/components/periodic-table-name-practice.tsx` se sdílenou mřížkou `periodic-table-grid.tsx`; směr název → pozice se nezměnil. PT-UX-3 a PT-UX-4 zůstávají naplánované. Obnovení rozpracované série po reloadu (oddíl „Offline, kompatibilita“) zatím chybí. Prioritní doplnění Sprintu 2 na základě uživatelské zpětné vazby k `/procvicovani/periodicka-tabulka/nazvy`; musí být dokončeno před označením tohoto režimu za hotový.
