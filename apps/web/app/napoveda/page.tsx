  ...
  return (
    <main className="mx-auto min-h-dvh w-full max-w-3xl px-5 py-8 sm:px-8">
      ...
      <header className="mt-5">
        <h1 className="text-3xl font-semibold tracking-tight text-slate-950">Nápověda</h1>
      ...
      <div className="mt-7 grid gap-5">
        ...
        <section aria-labelledby="help-offline" className="rounded-2xl border border-slate-200 p-5">
        ...
        <section aria-labelledby="help-sources" className="rounded-2xl border border-slate-200 p-5">
      ...
      <footer className="mt-7 border-t border-slate-200 pt-4">
